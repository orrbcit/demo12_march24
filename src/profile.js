...
document.getElementById('editButton').addEventListener('click', editUserInfo);
...
async function saveUserInfo() {
    ...
    console.log("User entered values:", userName, userSchool, userCity);
